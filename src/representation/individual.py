...
class Individual(object):
    ...
    def __init__(self, genome, ind_tree, map_ind=True):
        ...
        self.fitness_auroc = params['FITNESS_FUNCTION'].default_auroc
        self.fitness_Pearson_corr = params['FITNESS_FUNCTION'].default_Pearson_corr
    ...
    def evaluate(self):
        ...
        self.fitness, self.fitness_auroc, self.fitness_Pearson_corr = params['FITNESS_FUNCTION'](self)
